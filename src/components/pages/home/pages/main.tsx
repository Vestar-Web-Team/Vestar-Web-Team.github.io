...
export default function MainPage() {
    ...
    return <Page className="pt-6 pl-4 flex flex-col justify-between max-w-sm">
        ...
        {/* 立绘 */}
        <Image
            className={mergeClassName("absolute left-0 bottom-0 w-fit max-w-full h-5/6 object-cover object-center", styles.sprite)}
        ...
        <div className='mb-4 flex'>
            ...
            <div className='flex flex-col w-36 h-28 mt-4'>
                <StarButton className='flex items-center justify-evenly h-12 border-2 border-primary-950 text-primary-300 bg-primary-700' icon={<Svg src={publicUse('/images/bilibili.svg')} className='bg-primary-700' rootClassName='w-4 h-4 absolute top-1/2 left-1/2 -translate-x-full -translate-y-1/2' />}>BiliBili</StarButton>
                <StarButton className='flex items-center justify-evenly h-12 border-2 border-primary-950 text-primary-300 bg-primary-700 mt-4' icon={<Svg src={publicUse('/images/bilibili.svg')} className='bg-primary-700' rootClassName='w-4 h-4 absolute top-1/2 left-1/2 -translate-x-full -translate-y-1/2' />}>BiliBili</StarButton>
            </div>
        </div>
    </Page>;
}